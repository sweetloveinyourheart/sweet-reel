...
const defaultShortDescription = "Sweet Real Video Management"
...
//go:generate go run github.com/sweetloveinyourheart/sweet-reel/cmd/standalone/video_management generate
